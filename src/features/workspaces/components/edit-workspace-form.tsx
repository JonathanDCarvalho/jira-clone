...
export const EditWorkspaceForm = ({ onCancel, initialValues }: EditWorkspaceFormProps) => {
	...
	const [DeleteDialog, confirmDelete] = useConfirm("Delete Workspace", "This actio cannot be undone.", "destructive");
												...
												<div className="flex items-center gap-x-5">
													{field.value ? (
														<div className="size-[72px] relative rounded-md overflow-hidden">
															<Image className="object-cover" fill alt="Logo" src={field.value instanceof File ? URL.createObjectURL(field.value) : field.value} />
														</div>
													) : (
