...
interface DottedSeparatorProps {
	...
	dotSize?: string;
	gapSize?: string;
	diretion?: "horizontal" | "vertical";
}

export const DottedSeparator = ({ className, color = "#d4d4d8", height = "2px", dotSize = "2px", gapSize = "6px", diretion = "horizontal" }: DottedSeparatorProps) => {
	const isHorizontal = diretion === "horizontal";
